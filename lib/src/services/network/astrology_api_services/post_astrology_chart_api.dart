...
class PostAstrologyChartServicesApi extends BaseApiService {
  Future postAstrologyChart(PostAstroModel postAstroModel) async {
    dynamic responseJson;
    try {
      var dio = Dio();
      final prefs = await SharedPreferences.getInstance();
      String? authtoken = prefs.getString(authToken);
      var response = await dio.post(astrologyChartPostURL,
          options: Options(
              headers: {
      ...
      print("::::::::<Post astrology chart>::::::::status code::::::::::::::");
